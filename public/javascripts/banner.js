...
ZoomPic.prototype = { //prototype 向对象添加属性和方法
    initialize : function (id){ //将initialize作为一个属性
        ...
        //循环图片的大小及属性 options为集合表示
            {width:11, height:150, top:71, left:134, zIndex:1},
            {width:11, height:170, top:61, left:0, zIndex:2},
            {width:13.5, height:218, top:37, left:110, zIndex:3},
            {width:16, height:288, top:0, left:262, zIndex:4},
            {width:13.5, height:218, top:37, left:468, zIndex:3},
            {width:11, height:170, top:61, left:620, zIndex:2},
            {width:11, height:150, top:71, left:496, zIndex:1}
        ];
